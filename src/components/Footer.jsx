  ...
  return (
    <footer className='px-auto relative mt-44 overflow-hidden'>
        <div className='max-w-7xl mx-auto'>
            ...
            <div className='flex flex-wrap gap-6 justify-between pb-8'>
                ...
                <div>
                    ...
                    <div className='space-y-2'>
                            <Animated>
                                <a href="mailto: hello@gmail.com" className='flex items-center gap-1 text-zinc-600 hover:text-zinc-500'>
                            ...
                            <Animated delay={0.2}>
                                <a href="tel: +92-123456789" className='flex items-center gap-1 text-zinc-600 hover:text-zinc-500'>
            ...
            {/* Bottom bar */}
            <div className='border-t text-zinc-500 border-salte-200 py-4.5 flex justify-between items-center'>
                <p>© 2026. All Right Reserved.</p>
                <p>Designed & built by  Hassan Rao</p>
            </div>
        </div>
